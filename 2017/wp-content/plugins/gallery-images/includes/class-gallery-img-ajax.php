...
///////////////////////////////
                ...
                $output .= '<div class="view ' . esc_html($_POST["view_style"]) . ' element ' . $no_title . ' element_' . $idofgallery . ' " tabindex="0" data-symbol="' . $video_name . '"  data-category="alkaline-earth">';
            ...
            foreach ($page_images as $key => $row) {
                ...
                switch ($imagerowstype) {
                    case 'image':
                        ...
                        $video = '
                        <a class="gallery_group' . $idofgallery . '" href="' . $row->image_url . '" title="' . $video_name . '">
