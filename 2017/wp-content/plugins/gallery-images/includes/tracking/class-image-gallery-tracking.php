...
class Hugeit_image_Gallery_Tracking
{
    /**
     * Hugeit_Image_Gallery_Tracking constructor.
     */
    public function __construct()
    {

        if (isset($_GET['hugeit_image_gallery_tracking_opt_in'])) {
            add_action('admin_init', array($this, 'maybe_opt_in'));
        }

        add_action('admin_notices', array($this, 'admin_notice'));
        add_action('hugeit_image_gallery_opt_in_cron', array($this, 'track_data'));
    }
    ...
    public function maybe_opt_in()
    {
        ...
        $opt_in_action = htmlspecialchars($_GET['hugeit_image_gallery_tracking_opt_in']);
        ...
        header('Location: ' . admin_url('admin.php?page=galleries_huge_it_gallery'));
    ...
    public function admin_notice()
    {
        ...
        echo Gallery_Img_Template_Loader::render(GALLERY_IMG_TEMPLATES_PATH . '/admin/tracking/banner/show.php', compact('optin_url', 'optout_url'));
    }
    ...
    {
        return add_query_arg('hugeit_image_gallery_tracking_opt_in', 1, admin_url('admin.php?page=galleries_huge_it_gallery'));
    }
    ...
    {
        return add_query_arg('hugeit_image_gallery_tracking_opt_in', 0, admin_url('admin.php?page=galleries_huge_it_gallery'));
    }
    ...
    {
        return ('opted_in' === get_option('hugeit_image_gallery_allow_tracking', false));
    }
    ...
    {
        return ('opted_out' === get_option('hugeit_image_gallery_allow_tracking', false));
    }
    ...
    {
        update_option('hugeit_image_gallery_allow_tracking', 'opted_in');
    }
    ...
    {
        update_option('hugeit_image_gallery_allow_tracking', 'opted_out');
    }
    ...
    public function track_data()
    {
        ...
        $data["project_id"] = Gallery_Img()->get_project_id();
        $data["project_plan"] = Gallery_Img()->get_project_plan();
        $data["project_version"] = Gallery_Img()->get_version();
