...
?>
    ...
    <div class="wrap">
        ...
        <form action="admin.php?page=galleries_huge_it_gallery&id=<?php echo $row->id; ?>&save_data_nonce=<?php echo $save_data_nonce; ?>"
                        ...
                        <div id="side-sortables" class="meta-box-sortables ui-sortable">
                            <div id="gallery-unique-options" class="postbox">
                                ...
                                <ul id="gallery-unique-options-list">
                                    ...
                                    <ul id="hover_effects">
                                        <li>
                                            <label for="hovers"><?php echo __('Hover effects', 'gallery-img'); ?></label>
                                            <select id="hover" name="hovers">
                                                <option <?php if ($row->hover_effect == 0) {
                                                    echo 'selected';
                                                } ?> value="0"><?php echo __('Dark', 'gallery-img'); ?></option>
                                                <option <?php if ($row->hover_effect == 1) {
                                                    echo 'selected';
                                                } ?> value="1"><?php echo __('Blur', 'gallery-img'); ?></option>
                                                <option <?php if ($row->hover_effect == 2) {
                                                    echo 'selected';
                                                } ?> value="2"><?php echo __('Scale', 'gallery-img'); ?></option>
                                                <option <?php if ($row->hover_effect == 3) {
                                                    echo 'selected';
                                                } ?> value="3"><?php echo __('Content on bottom', 'gallery-img'); ?></option>
                                                <option <?php if ($row->hover_effect == 4) {
                                                    echo 'selected';
                                                } ?> value="4"><?php echo __('Elastic', 'gallery-img'); ?></option>
