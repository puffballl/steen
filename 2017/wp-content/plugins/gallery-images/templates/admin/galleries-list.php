...
<div class="wrap">
    ...
    <div id="poststuff" style="    border: 1px solid #e5b126;padding: 10px;">
                ...
                <table class="wp-list-table widefat fixed pages" style="width:100%">
                    ...
                    for ($i = 0; $i < count($rows); $i++) {
                        ...
                        <tr <?php if ($trcount % 2 == 0) {
                            ...
                            <td>
                                <a href="admin.php?page=galleries_huge_it_gallery&task=duplicate_gallery_image&id=<?php echo $rows[$i]->id; ?>&gallery_duplicate_nonce=<?php echo $huge_it_gallery_nonce_duplicate_gallery; ?>"
                                   class="duplicate-link"><span class="duplicate-icon"></span></a>
                            <td>
                                <a href="admin.php?page=galleries_huge_it_gallery&task=remove_gallery&id=<?php echo $rows[$i]->id; ?>&huge_it_gallery_nonce_remove_gallery=<?php echo $huge_it_gallery_nonce_remove_gallery; ?>"
